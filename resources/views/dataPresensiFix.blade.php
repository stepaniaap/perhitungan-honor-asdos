...
<a href="/home_biro" class="btn btn-outline-secondary btn-sm">Kembali</a>
<br>
<br>
...
{{-- <form method="get" action="{{ url('/searchDataByMonth') }}"> --}}
 ...
 <table class="table">
     ...
     <form action="/hitung" method="POST">
      @csrf
      <a href="/hitung/{{$data->id}}" class="btn btn-outline-secondary btn-sm">Hitung Gaji</a>
    </form>
 </table>
 </div>
...
<br>
<br>
<center><h2>Gaji Perbulan</h2></center>
<div class="container">
<table class="table">
    <thead>
        <tr>
    ...
    <tbody>
      <tr>
         ...
         <td>Rp{{ $datagaji->bulan}}</td>
            <td>Rp{{ $datagaji->gaji_total}}</td>
         @endforeach
      </tr>
   </tbody>
